...
## Pipeline unificata
La pipeline usa ora un solo elenco responsive: la stessa scheda si adatta da desktop a mobile. Non esistono più una tabella desktop e una seconda serie di card duplicate.
