  ...
  const i18n = {
    it: {
      ...
      dashboard:{
        ...
        title:'RICERCA INVESTITORI.<br><span class="neon-text">TUTTO SOTTO CONTROLLO.</span>',
        intro:'Una vista semplice e operativa per capire quanti prospect stiamo studiando, chi è stato contattato, quali follow-up sono aperti e quali risultati stanno emergendo.',
        openPipeline:'Apri pipeline',
        funnelKicker:'PIPELINE',funnelTitle:'Distribuzione per stadio',
        nextKicker:'PROSSIME AZIONI',nextTitle:'Follow-up in agenda',manage:'Gestisci ↗',
        activityKicker:'ATTIVITÀ RECENTE',activityTitle:'Cosa è stato fatto'
      },
      pipeline:{
        eyebrow:'CRM INVESTITORI',
        title:'PIPELINE<br><span class="neon-text">INVESTITORI.</span>',
        intro:'Ogni prospect ha uno stadio, una priorità, una cronologia e una prossima azione. Clicca su un nome per aprire la scheda completa.',
        listKicker:'PROSPECT',listTitle:'Elenco investitori'
      },
      table:{name:'Prospect',type:'Tipo',stage:'Stadio',priority:'Priorità',last:'Ultimo contatto',next:'Prossima azione',actions:'Azioni'},
      form:{
        name:'Nome',type:'Tipo',stage:'Stadio',priority:'Priorità',contactName:'Referente',contactRole:'Ruolo',phone:'Telefono',
        website:'Sito / Link',lastContact:'Ultimo contatto',nextDate:'Prossimo follow-up',thesis:'Perché è rilevante / tesi',
        source:'Fonte',nextAction:'Prossima azione',notes:'Note interne'
      },
      detail:{
        back:'← Torna alla pipeline',overviewKicker:'SCHEDA',overviewTitle:'Informazioni principali',
        nextKicker:'FOLLOW-UP',nextTitle:'Prossima azione',thesisKicker:'TESI',thesisTitle:'Perché è rilevante',
        activityKicker:'CRONOLOGIA',activityTitle:'Attività e contatti',notesKicker:'NOTE',notesTitle:'Note interne'
      },
      ...
      empty:{
        followups:'Nessun follow-up con data impostata.',
        activities:'Nessuna attività registrata.',
        pipeline:'Nessun prospect corrisponde ai filtri.',
        notFound:'Investitore non trovato.'
      }
    },
    en: {
      nav:{dashboard:'Dashboard',pipeline:'Investor pipeline'},
      actions:{
        backup:'Data backup',addInvestor:'+ Add prospect',edit:'Edit',delete:'Delete',cancel:'Cancel',save:'Save',
        open:'Open record',addActivity:'+ Add activity'
      },
      dashboard:{
        eyebrow:'INVESTOR RELATIONS / MISSION CONTROL',
        title:'INVESTOR RESEARCH.<br><span class="neon-text">UNDER CONTROL.</span>',
        intro:'A simple operational view of how many prospects are being researched, who has been contacted, which follow-ups are open and what results are emerging.',
